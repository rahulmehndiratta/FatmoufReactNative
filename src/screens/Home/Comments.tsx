...
const Comments: React.FC<Props> = (props: any) => {
  ...
  return (
    <MySafeArea componentId={props.componentId} title="Comments">
      <FlatList data={[0, 1, 2]} renderItem={_renderItems} />
    </MySafeArea>
  );
};
