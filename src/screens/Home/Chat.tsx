    ...
    return (
      <View style={[styles.mainContainer, {
        ...
        <View style={styles.msgContainer}>
          ...
          />
          <Text style={[styles.tvMessage, {}]}>Hellogfghgfdgrgsgdgdgdrgrffdgrttggtvstdhffgh</Text>
        </View>
        <Text style={{
          marginLeft: 10, fontSize: fontSize.size_12, marginRight: index == 0 ? 20 : null,
          alignSelf: index == 0 ? 'flex-end' : 'flex-start'
        }}>lilll 8:31Am</Text>
      </View>
    );
  ...
  return (
    <MySafeArea
      ...
      <FlatList
        ...
        data={[1, 2, 3]} renderItem={_renderItems} />

      <View style={{
        backgroundColor: color.boderColor, flexDirection: 'row',
        alignItems: 'center',
        height: 60,
