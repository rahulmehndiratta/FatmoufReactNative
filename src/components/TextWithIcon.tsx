...
const TextWithIcon: React.FC<Props> = (props) => {
    ...
    return (
        <View style={[styles.container, {
            ...
            <Text style={[styles.tvTitle, { color: textColor, fontSize: fontSizes, fontFamily: fontFamilies }]}>{title}</Text>
...
const styles = StyleSheet.create({
    ...
    tvTitle: {
        ...
        color: color.activeDotColor,
        marginStart: Utils.calculateHeight(15)
    }
})
